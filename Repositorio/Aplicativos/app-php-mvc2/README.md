...
Adicionei a estrutura de um novo CRUD, products, praticamente duplicando o aplicativo.
Como fiz isso: saí duplicando cada arquivo e adaptando de clients para products.
