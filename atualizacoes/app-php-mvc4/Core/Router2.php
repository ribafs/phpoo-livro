...
class Router
{
  ...
  private $urlParams = array();
    ...
    // Caso o controller da url exista na pasta App, então crie uma instância do mesmo
    } elseif (file_exists(APP . 'Controllers/ClientsController.php')) {
        $controller = 'App\\Controllers\\ClientsController';
        $this->urlController = new $controller();
        // Caso o método da url exista e seja chamável
        $this->urlAction = $this->urlAction ? $this->urlAction : 'index';
        if (method_exists($this->urlController, $this->urlAction) && is_callable(array($this->urlController, $this->urlAction))) {                
            ...
            if (!empty($this->urlParams)) {
            	// A função call_user_func_array chama dois arrays, Se não for vazio chame o controller, o action e os paprâmetros
    ...
    } elseif (file_exists(APP . 'Controllers/ProductsController.php')) {
